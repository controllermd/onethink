...
<body>
    ...
    <form action="<?php echo isset($info['id'])?U('edit'):U('add');?>" method="post" class="form-horizontal">
        <input type="hidden" name="name" value="<?php echo session('user_auth.username');?>" />
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="price" value="<?php echo ((isset($info["price"]) && ($info["price"] !== ""))?($info["price"]):''); ?>">单位：
                <select name="company">
                            <option value="1" <?php if($info["company"] == 1): ?>selected<?php endif; ?>>元/月</option>
                            <option value="2" <?php if($info["company"] == 2): ?>selected<?php endif; ?>>万元/月</option>
                        </eq>
                </select>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
                <select name="types">
                        <option value="1" <?php if($info["company"] == 1): ?>selected<?php endif; ?>>出售</option>
                        <option value="2" <?php if($info["company"] == 2): ?>selected<?php endif; ?>>出租</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <label class="textarea">
                ...
                <?php echo hook('adminArticleEdit', array('name'=>content,'value'=>$data[content]));?>
            </label>
        </div>
        <div class="form-item">
            <label class="item-label">简单描述</label>
            <div class="controls">
                <label class="textarea input"><textarea name="rule"><?php echo ((isset($info["rule"]) && ($info["rule"] !== ""))?($info["rule"]):''); ?></textarea></label>
            </div>
        </div>
        <div class="form-item">
            <div class="row">
                <label class="item-label">截止时间：</label>
                <input type="text" id="time-start" name="over_time" class="text input" value="<?php echo ((isset($info["over_time"]) && ($info["over_time"] !== ""))?($info["over_time"]):''); ?>" placeholder="截止时间" />
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">联系电话<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" name="tel" class="text input" value="<?php echo ((isset($info["tel"]) && ($info["tel"] !== ""))?($info["tel"]):''); ?>" />
            </div>
        </div>
        <div class="form-item">
